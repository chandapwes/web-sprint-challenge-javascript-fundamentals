...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// nestedFunction has access to myfunction's variable(internal) because nestedFunction is defined within myFunction. functions defined within other functions have access to the outer functions variables through a behavior called lexical scoping. 
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(){
   const newArr = zooAnimals.filter(function(item){
